...
export const columns = [
                ...
                <>
                    <div className=" flex gap-1 items-center ">
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuSeparator />
                                <DropdownMenuItem onClick={() => setOpenPublisher(true)}>
                                    <SquarePen /> Edit Publisher
                                </DropdownMenuItem>
                    ...
                    {openPublisher && (
                        <EditPublisherDialog
                            ...
                            setOpenPublisher={setOpenPublisher}
                        />
                    )}
    ...
    {
        accessorKey: "name",
        header: () => <div className="">Publisher Name</div>,
...
export function PublisherDataTable({ data }) {
