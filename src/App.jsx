...
import BoardPage from './pages/board-demo/BoardPage'
import ProvincePage from './pages/province-demo/ProvincePage'
import ClassPage from './pages/class-demo/ClassPage'
